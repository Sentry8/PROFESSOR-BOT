...
* `DATABASE_NAME`: Name of the database in [mongoDB][(https://www.mongodb.com).](https://github.com/Sentry8/PROFESSOR-BOT) For more help watch this [video](https://youtu.be/1G1XwEOnxxo)
